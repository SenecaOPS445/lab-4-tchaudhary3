...
def middle_number(input_num):
    ...
    """
    # Convert the number to a string and slice the second and third characters
    return str(input_num)[1:3]

def first_three_last_three(str1, str2):
    """
    Returns a string starting with the first three characters of str1
    and ending with the last three characters of str2.
    """
